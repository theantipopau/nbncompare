...
export default function App() {
  return (
    <div className="container">
      ...
      <main>
        {location.pathname === '/admin' ? <Admin /> : location.pathname.startsWith('/providers/') ? <Provider slug={location.pathname.replace('/providers/', '')} /> : location.pathname === '/status' ? <Status /> : location.pathname === '/about' ? <About /> : <Compare />}
      </main>
      <footer>
