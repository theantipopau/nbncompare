...
async function searchAddress(request) {
  try {
    ...
    const results = suggestions.filter((item) => item.id && item.id.startsWith("LOC")).map((item) => ({
      id: item.id,
...
__export(favicon_exports, {
  fetchProviderFavicon: () => fetchProviderFavicon,
  updateProviderFavicons: () => updateProviderFavicons
});
async function fetchProviderFavicon(domain) {
  try {
    const attempts = [
...
async function updateProviderFavicons() {
  ...
  for (const provider of providers.results || []) {
    ...
    if (domain) {
      ...
      if (faviconUrl) {
        await db.prepare("UPDATE providers SET favicon_url = ? WHERE id = ?").bind(faviconUrl, provider.id).run();
      }
    }
  }
  return { updated: providers.results?.length || 0 };
}
var init_favicon = __esm({
  "src/lib/favicon.ts"() {
    "use strict";
    init_db();
    __name(fetchProviderFavicon, "fetchProviderFavicon");
...
function normalizeSpeed(text) {
  ...
  if (typeof text === "number") {
    const n = text;
    if ([12, 25, 50, 100, 200, 250, 400, 500, 1e3, 2e3].includes(n)) return n;
    return null;
  }
...
function validatePlan(p2) {
  ...
  if (p2.ongoingPriceCents !== null) {
    if (p2.ongoingPriceCents < 3e3 || p2.ongoingPriceCents > 2e4) {
      errors.push(`ongoing_price_cents ${p2.ongoingPriceCents} out of plausible range`);
    }
  }
  if (p2.speedTier !== null) {
    if (![12, 25, 50, 100, 250, 500, 1e3].includes(p2.speedTier)) errors.push(`unknown speed tier ${p2.speedTier}`);
  }
  if (p2.introPriceCents !== null && p2.ongoingPriceCents === null) errors.push("intro price present but ongoing price missing");
...
var require_parse3 = __commonJS({
  "../../node_modules/.pnpm/cssom@0.5.0/node_modules/cssom/lib/parse.js"(exports) {
    var CSSOM = {};
    CSSOM.parse = /* @__PURE__ */ __name(function parse12(token) {
      var i = 0;
...
var require_style_element = __commonJS({
  "../../node_modules/.pnpm/linkedom@0.18.12/node_modules/linkedom/cjs/html/style-element.js"(exports) {
    "use strict";
    var { parse: parse12 } = require_lib8();
    var { registerHTMLClass } = require_register_html_class();
    ...
    var HTMLStyleElement = class extends TextElement {
      ...
      get sheet() {
        ...
        return this[SHEET] = parse12(this.textContent);
      }
      get innerHTML() {
...
var require_parse_json = __commonJS({
  "../../node_modules/.pnpm/linkedom@0.18.12/node_modules/linkedom/cjs/shared/parse-json.js"(exports) {
    ...
    var parseJSON = /* @__PURE__ */ __name((value) => {
      const array = typeof value === "string" ? parse12(value) : value;
      const { length } = array;
...
// ../../packages/shared/src/parsers/dom-utils.ts
...
// ../../packages/shared/src/parsers/generic.ts
var generic_exports = {};
__export(generic_exports, {
  canHandle: () => canHandle11,
  parse: () => parse11
});
function canHandle11(_url) {
  return true;
}
...
function findParserForUrl(url) {
  for (const p2 of PROVIDER_PARSERS) {
    try {
      if (p2.canHandle && p2.canHandle(url)) return p2;
    } catch (e) {
    }
  }
...
var init_parsers = __esm({
  "../../packages/shared/src/parsers/index.ts"() {
    ...
    init_foxtel();
    init_generic();
    PROVIDER_PARSERS = [telstra_exports, optus_exports, tpg_exports, vodafone_exports, superloop_exports, kogan_exports, foxtel_exports, aussiebroadband_exports, spintel_exports, dodo_exports];
