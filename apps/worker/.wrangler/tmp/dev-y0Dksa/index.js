...
// C:/Users/matth/AppData/Roaming/npm/node_modules/wrangler/templates/modules-watch-stub.js
...
async function recordRunStartEnd({ started, runId, notes }) {
  ...
  if (started) {
    ...
    const r2 = await db.prepare("INSERT INTO runs (started_at, status) VALUES (?, ?)").bind(now, "running").run();
    return r2.meta.last_row_id;
  } else {
    const now = (/* @__PURE__ */ new Date()).toISOString();
...
async function getPlans(req, env) {
  try {
    ...
    if (discount === "1") {
      q += ` AND p.intro_price_cents IS NOT NULL`;
    }
    if (contractType) {
    ...
    const rows = rowsRes && rowsRes.results ? rowsRes.results : rowsRes;
...
async function getProviderComparison(request, env) {
  try {
    ...
    const providers = await db.prepare(`
      ...
      ORDER BY name ASC
    `).all();
    const features = providers.results.map((p2) => ({
      id: p2.id,
      name: p2.name,
      slug: p2.slug,
      logo_url: p2.logo_url,
      features: {
        ipv6: {
          label: "IPv6 Support",
          value: p2.ipv6_support,
          display: p2.ipv6_support ? "\u2713" : "\u2717"
        },
        cgnat: {
          label: "CGNAT",
          value: p2.cgnat,
          display: p2.cgnat ? `Uses CGNAT${p2.cgnat_opt_out ? p2.cgnat_opt_out === 1 ? " (free opt-out)" : " (paid opt-out)" : ""}` : "No CGNAT"
        },
        static_ip: {
          label: "Static IP",
          value: p2.static_ip_available,
          display: p2.static_ip_available === 0 ? "\u2717" : p2.static_ip_available === 1 ? "Free" : "Paid addon"
        },
        australian_support: {
          label: "Support",
          value: p2.australian_support,
          display: p2.australian_support === 2 ? "100% Australian" : p2.australian_support === 1 ? "Mixed (AU+Offshore)" : "Offshore"
        },
        parent_company: {
          label: "Parent Company",
          value: p2.parent_company,
          display: p2.parent_company || "Independent"
        }
      },
      description: p2.description,
      support_hours: p2.support_hours
    }));
    return new Response(
  ...
  try {
    ...
    return new Response(
      JSON.stringify({
        ...
        alternatives,
        total_potential_savings: Math.round(alternatives.reduce((sum, a) => sum + a.savings, 0) * 100) / 100,
...
function normalizeSpeed(text) {
  ...
  if (typeof text === "number") {
    const n = text;
    if ([12, 25, 50, 100, 200, 250, 400, 500, 1e3, 2e3].includes(n))
      return n;
    return null;
  }
...
function validatePlan(p2) {
  const errors = [];
  const warnings = [];
  const planName = (p2.planName || "").trim();
  const sourceUrl = (p2.sourceUrl || "").trim();
  if (!planName)
  ...
  const price = p2.ongoingPriceCents ?? p2.introPriceCents;
  if (price === null) {
  ...
  if (p2.ongoingPriceCents !== null) {
    if (p2.ongoingPriceCents < 3e3)
      warnings.push(`ongoing_price_cents ${p2.ongoingPriceCents} unusually low`);
    if (p2.ongoingPriceCents > 3e4)
      warnings.push(`ongoing_price_cents ${p2.ongoingPriceCents} unusually high`);
  }
  if (p2.introPriceCents !== null && p2.ongoingPriceCents !== null) {
    if (p2.introPriceCents > p2.ongoingPriceCents)
      warnings.push("intro price higher than ongoing price");
  }
  if (p2.uploadSpeedMbps !== void 0 && p2.uploadSpeedMbps !== null && p2.speedTier !== null) {
    if (p2.uploadSpeedMbps > p2.speedTier)
...
var require_decode_data_html = __commonJS({
  "../../node_modules/.pnpm/entities@6.0.1/node_modules/entities/dist/commonjs/generated/decode-data-html.js"(exports) {
    "use strict";
    init_modules_watch_stub();
...
var require_decode_data_xml = __commonJS({
  "../../node_modules/.pnpm/entities@6.0.1/node_modules/entities/dist/commonjs/generated/decode-data-xml.js"(exports) {
    "use strict";
    init_modules_watch_stub();
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_decode_codepoint = __commonJS({
  "../../node_modules/.pnpm/entities@6.0.1/node_modules/entities/dist/commonjs/decode-codepoint.js"(exports) {
    "use strict";
    init_modules_watch_stub();
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_decode = __commonJS({
  "../../node_modules/.pnpm/entities@6.0.1/node_modules/entities/dist/commonjs/decode.js"(exports) {
    "use strict";
    init_modules_watch_stub();
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../node_modules/.pnpm/htmlparser2@10.0.0/node_modules/htmlparser2/dist/commonjs/Tokenizer.js
var require_Tokenizer = __commonJS({
  "../../node_modules/.pnpm/htmlparser2@10.0.0/node_modules/htmlparser2/dist/commonjs/Tokenizer.js"(exports) {
    "use strict";
    init_modules_watch_stub();
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../node_modules/.pnpm/htmlparser2@10.0.0/node_modules/htmlparser2/dist/commonjs/Parser.js
var require_Parser = __commonJS({
  "../../node_modules/.pnpm/htmlparser2@10.0.0/node_modules/htmlparser2/dist/commonjs/Parser.js"(exports) {
    "use strict";
    init_modules_watch_stub();
...
// ../../node_modules/.pnpm/htmlparser2@10.0.0/node_modules/htmlparser2/dist/commonjs/index.js
var require_commonjs = __commonJS({
  "../../node_modules/.pnpm/htmlparser2@10.0.0/node_modules/htmlparser2/dist/commonjs/index.js"(exports) {
    "use strict";
    init_modules_watch_stub();
    var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o2, m, k, k2) {
      if (k2 === void 0) k2 = k;
...
var require_parse3 = __commonJS({
  "../../node_modules/.pnpm/cssom@0.5.0/node_modules/cssom/lib/parse.js"(exports) {
    init_modules_watch_stub();
    var CSSOM = {};
    CSSOM.parse = /* @__PURE__ */ __name(function parse14(token) {
      var i = 0;
...
var require_style_element = __commonJS({
  "../../node_modules/.pnpm/linkedom@0.18.12/node_modules/linkedom/cjs/html/style-element.js"(exports) {
    "use strict";
    init_modules_watch_stub();
    var { parse: parse14 } = require_lib8();
    var { registerHTMLClass } = require_register_html_class();
    ...
    var HTMLStyleElement = class extends TextElement {
      ...
      get sheet() {
        ...
        return this[SHEET] = parse14(this.textContent);
      }
      get innerHTML() {
...
var require_parse_json = __commonJS({
  "../../node_modules/.pnpm/linkedom@0.18.12/node_modules/linkedom/cjs/shared/parse-json.js"(exports) {
    ...
    var parseJSON = /* @__PURE__ */ __name((value) => {
      const array = typeof value === "string" ? parse14(value) : value;
      const { length } = array;
...
async function parse2(html, url) {
  ...
  if (rows.length === 0) {
    ...
    for (const p2 of priceEls) {
      results.push({
        providerSlug: "spintel",
        planName: p2.previousElementSibling?.textContent?.trim() || "Plan",
        speedTier: null,
        introPriceCents: parsePriceToCents(p2.textContent || ""),
        introDurationDays: null,
        ongoingPriceCents: parsePriceToCents(p2.textContent || ""),
        minTermDays: null,
        setupFeeCents: null,
        modemCostCents: null,
        conditionsText: null,
...
async function parse3(html, url) {
  ...
  return plans.map((p2) => {
    const name = p2.querySelector("h3, h2, .title")?.textContent?.trim() || "Not stated";
    const price = p2.querySelector(".price")?.textContent || p2.textContent || "";
    const s = (p2.textContent || "").match(/NBN\s*(\d{1,4})/i)?.[1] ?? null;
    return {
      providerSlug: "dodo",
      planName: name,
      speedTier: normalizeSpeed(s ? parseInt(s) : null),
...
async function parse12(html, url) {
  ...
  for (const element of planElements) {
    ...
    if (!introPriceCents && !ongoingPriceCents)
      continue;
    const uploadMatch = text.match(/(\d+)\s*\/\s*(\d+)\s*Mbps/i) || text.match(/Upload[:\s]+(\d+)\s*Mbps/i);
...
function findParserForUrl(url) {
  for (const p2 of PROVIDER_PARSERS) {
    try {
      if (p2.canHandle && p2.canHandle(url))
        return p2;
    } catch {
    }
  }
...
var init_parsers = __esm({
  "../../packages/shared/dist/parsers/index.js"() {
    ...
    init_arctel();
    init_generic();
    PROVIDER_PARSERS = [telstra_exports, optus_exports, tpg_exports, vodafone_exports, superloop_exports, kogan_exports, foxtel_exports, aussiebroadband_exports, spintel_exports, dodo_exports, exetel_exports, arctel_exports];
...
async function fetchProvidersToUpdate(env, maxProviders = 5) {
  ...
  const providersRes = typeof stmt.all === "function" ? await stmt.all() : { results: [] };
  const providers = providersRes && providersRes.results ? providersRes.results : [];
...
async function processProvider(db, prov, result) {
  result.checked++;
...
async function handleCron() {
  ...
  try {
    const result = await fetchProvidersToUpdate(void 0, 30);
...
// .wrangler/tmp/bundle-BZYtD7/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-BZYtD7/middleware-insertion-facade.js
init_modules_watch_stub();
...
try {
  ...
  router.post("/api/admin/review/approve", async (request) => {
    const { adminApprove: adminApprove2 } = await Promise.resolve().then(() => (init_admin(), admin_exports));
    return adminApprove2(request, { ADMIN_TOKEN: globalThis.ADMIN_TOKEN });
  });
...
router.get("/internal/cron/run", async () => {
  try {
    ...
    const result = await handleCron2();
    return new Response(JSON.stringify({ ok: true, result }), { status: 200, headers: { "Content-Type": "application/json" } });
  } catch (err) {
...
router.get("/internal/ping", async () => {
  try {
    ...
    const r2 = await db.prepare("SELECT 1 as ok").first();
    return new Response(JSON.stringify({ ok: true, db: !!r2 }), { status: 200, headers: { "Content-Type": "application/json" } });
  } catch (err) {
...
var src_default = { fetch: fetch2, scheduled };

// C:/Users/matth/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
init_modules_watch_stub();
...
// C:/Users/matth/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
init_modules_watch_stub();
...
// C:/Users/matth/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/common.ts
init_modules_watch_stub();
